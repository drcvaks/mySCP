...
3. רמב״ם - Shmuel allows eating the fish with dairy even if it was fried in a fleishig pan because the meat flavor was weakened twice: from meat to the pan and from pan to the fish; the cheese was added only after.

4. איסור והיתר (quoted by the דרכי משה) - le’chatchilla, if fish was either cooked or fried in a fleishig pot/pan, you should not eat it with dairy (like the ריב"ן), but if dairy was mistakenly added to it, it may be eaten, even if the fish was fried in afleishig pan (like the רמב״ם). Furthermore, everyone would agree that you are allowed to place hot fish that was cooked in a fleishig pot/pan on a dairy plate. Lastly, we are only machmirnot to eat fish cooked in a fleishig pot/pan with dairy if the pot/pan is ben-yomo (and the meat flavor is still strong). However, if the pot/pan is eino ben-yomo, the fish may be eaten with dairy le’chatchilla.$chunk$,
  updated_at = now()
...
- Hot parve food cooked in a parve pot and placed on a fleishig plate may be eaten later with dairy (Gemara above quoted by Rama).$chunk$,
  updated_at = now()
